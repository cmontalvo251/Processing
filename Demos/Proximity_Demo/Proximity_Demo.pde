...
String [] names = {"Left (cm)","Right (cm)","Front (cm)","Var4","Var5","Var6","Var7","Var8","Var9","Var10","Var11","Var12"};  //Names of variables
float [] miny = {0,0,0,-4,-5,-6}; //max and min values of data read in
float [] maxy = {100,100,100,4,5,6};
...
{  
  ...
  port = new Serial(this,"/dev/ttyUSB0",9600); //set baud rate - make sure to have the arduino plugged in, otherwise the code will not work.
